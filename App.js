...
export default function App() {
  ...
  // Card component with shine effect on hover (web only)
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Want to get in touch? Feel free to reach out for collaborations, questions, or just to say hi!
        </Text>
        <View style={{ 
          ...
          <SocialButton iconSvg={linkedinSvg} text="Linked In" iconColor="#0e76a8" />
